...
public class SimpleBSP3Test extends TestCase {
    ...
    public void testApeTreeLikelihood1 () {
        ...
        System.out.println("SimpleBSP3 compared to classical skyline plot in Ape: " +
        ...
        LightweightTreeIntervals intervals = new LightweightTreeIntervals(tree);

        SimpleBSP3 skyline1 = new SimpleBSP3();
        skyline1.initByName("popSizes", "165 120  12  15  10", "groupSizes", "1 1 1 1 1", "treeIntervals", intervals);
    ...
    public void testApeTreeLikelihood3 () {
        ...
        System.out.println("SimpleBSP3 compared to generalized skyline plot in Ape: " +
                "Big tree with homochronous sampling.");
        ...
        skyline1.initByName("popSizes", popsizes, "groupSizes", groupsizes, "treeIntervals", intervals);
    ...
    public void testBSPTreeLikelihood1 () {
        ...
        System.out.println("SimpleBSP3 compared to old Bayesian Skyline implementation: " +
                "Tree with homochronous sampling.");

        Tree tree = new TreeParser("((D4Philip56:30.0,(D4Philip64:23.0,D4Philip84:23.0):7.0):10.0,(D4SLanka78:25.0,(D4Thai78:11.0,D4Thai84:11.0):14.0):15.0);",false);
        LightweightTreeIntervals intervals = new LightweightTreeIntervals(tree);
        TreeIntervals intervals2 = new TreeIntervals(tree);


        SimpleBSP3 skyline1 = new SimpleBSP3();
        skyline1.initByName("popSizes", "1.0 2.0", "groupSizes", "2 3", "treeIntervals", intervals);

        BayesianSkyline skyline2 = new BayesianSkyline();
        skyline2.initByName("popSizes", "1.0 2.0", "groupSizes", "2 3", "treeIntervals", intervals2);
    ...
    public void testBSPTreeLikelihood2 () {
        ...
        SimpleBSP3 skyline1 = new SimpleBSP3();
        skyline1.initByName("popSizes", "1.0 2.0", "groupSizes", "2 2", "treeIntervals", intervals);

        BayesianSkyline skyline2 = new BayesianSkyline();
        skyline2.initByName("popSizes", "1.0 2.0", "groupSizes", "2 2", "treeIntervals", intervals2);
